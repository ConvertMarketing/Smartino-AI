...
- LOGO VECTORIAL DE GRUP (SVG + AI/EPS, contururi convertite) - blocantul numarul unu. Nu exista niciun vector real in tot patrimoniul: shop e PNG 200x50, md e PNG 255x80, iar 'SVG'-ul lui home incapsuleaza raster. Fara acest asset nu se poate produce nicio firma luminosa, niciun print si niciun material peste 300px. Pana atunci, titlul paginii poarta `src/assets/logo/smartino-wordmark.png` - cuvantul-marca decupat din lockup-ul home (1380x257, turcoaz #0fb3c3 + gri #b8c9c8). Cand vine masterul, se inlocuieste doar acel fisier.
